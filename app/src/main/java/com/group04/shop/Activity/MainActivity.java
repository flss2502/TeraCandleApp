...
public class MainActivity extends BaseActivity {
    private ActivityMainBinding binding;
    private DatabaseReference mDatabase;
    private static final int CART_ACTIVITY_REQUEST_CODE = 1001;
    ...
    private void topNavigation() {
        binding.btnCart.setOnClickListener(v -> startActivityForResult(new Intent(MainActivity.this, CartActivity.class), CART_ACTIVITY_REQUEST_CODE));
    }
    ...
    private void updateCartItemCountInMainActivity(int itemCount) {
        binding.textView1.setText(String.valueOf(itemCount));
    }

    @Override
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        super.onActivityResult(requestCode, resultCode, data);
        if (requestCode == CART_ACTIVITY_REQUEST_CODE && resultCode == Activity.RESULT_OK) {
            int itemCount = data.getIntExtra("itemCount", 0);
            updateCartItemCountInMainActivity(itemCount);
        }
    }
}
