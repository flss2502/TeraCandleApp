...
import com.group04.shop.Activity.DetailActivity;
import com.group04.shop.Domain.ItemsDomain;
import com.group04.shop.databinding.ViewholderPopListBinding;
...
public class PopularAdapter extends RecyclerView.Adapter<PopularAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull PopularAdapter.Viewholder holder, int position) {
        ...
        holder.binding.priceTxt.setText(items.get(position).getPrice() + "VNĐ");
        holder.binding.ratingTxt.setText("(" + items.get(position).getRating() + ")");
        holder.binding.oldPriceTxt.setText(items.get(position).getOldPrice() + "VNĐ");
