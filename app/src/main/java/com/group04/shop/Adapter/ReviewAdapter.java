...
import com.group04.shop.Domain.ReviewDomain;
import com.group04.shop.databinding.ViewholderReviewBinding;
...
public class ReviewAdapter extends RecyclerView.Adapter<ReviewAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull ReviewAdapter.Viewholder holder, int position) {
        holder.binding.tvName.setText(items.get(position).getName());
        holder.binding.descTxt.setText(items.get(position).getDescription());
        holder.binding.tvRating.setText("" + items.get(position).getRating());
